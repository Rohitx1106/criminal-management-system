...
class Criminal:
    def __init__(self,root):
        ...
        img_2=img_2.resize((540,160),Image.BILINEAR)
        self.photo2=ImageTk.PhotoImage(img_2)

        self.img_2=Label(img_frame,image=self.photo2)
        self.img_2.place(x=540,y=5,width=540,height=160)

        # 3rd image
        img_3=Image.open('images/police3.jpeg')
        img_3=img_3.resize((540,160),Image.BILINEAR)
        ...
        txt_criminal_no=ttk.Entry(upper_frame,text=self.var_criminal_no,width=22,font=('arial',11,'bold'))
        ...
        txt_Name=ttk.Entry(upper_frame,text=self.var_name,width=22,font=('arial',11,'bold'))
        ...
        txt_nickname=ttk.Entry(upper_frame,text=self.var_nickname,width=22,font=('arial',11,'bold'))
        ...
        txt_arrestDate=ttk.Entry(upper_frame,text=self.var_arrest_date,width=22,font=('arial',11,'bold'))
        ...
        txt_dateOfCrime=ttk.Entry(upper_frame,text=self.var_date_of_crime,width=22,font=('arial',11,'bold'))
        ...
        txt_address=ttk.Entry(upper_frame,text=self.var_address,width=22,font=('arial',11,'bold'))
        ...
        txt_age=ttk.Entry(upper_frame,text=self.var_age,width=22,font=('arial',11,'bold'))
        ...
        txt_occupation=ttk.Entry(upper_frame,text=self.var_occupation,width=22,font=('arial',11,'bold'))
        ...
        txt_birthmark=ttk.Entry(upper_frame,text=self.var_birth_Mark,width=22,font=('arial',11,'bold'))
        ...
        txt_crimeType=ttk.Entry(upper_frame,text=self.var_crime_type,width=22,font=('arial',11,'bold'))
        ...
        txt_fatherName=ttk.Entry(upper_frame,text=self.var_father_name,width=22,font=('arial',11,'bold'))
        ...
        img_crime=img_crime.resize((470,245),Image.BILINEAR)
        ...
        search_txt.grid(row=0,column=2,sticky=W,padx=2)
    ...
    def add_data(self):
        if self.var_case_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Goldy11062003',database='management')
        ...
        if self.var_case_id.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='Goldy11062003',database='management')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update criminal1 set Criminial_no=%s,Criminal_name=%s,Nick_name=%s,arrest_date=%s,dateOfcrime=%s,address=%s,age=%s,occupation=%s,BirthMark=%s,crimeType=%s,fatherName=%s,gender=%s,wanted=%s where Case_id=%s',(
                ...
                self.clear_data()
                conn.close()
                messagebox.showinfo('Success','Criminal record successfully update')
            except Exception as es:
                messagebox.showerror('Error',f'Due To{str(es)}')   
